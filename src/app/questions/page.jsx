...
const allQuestions = {
  inception: [
    ...
    },
    {
      ...
      options: ["Mountain fortress", "City street", "Hotel", "Beach"],
      answer: "Mountain fortress"
    },
    {
      question: "Who plays Eames?",
      options: ["Tom Hardy", "Joseph Gordon-Levitt", "Cillian Murphy", "Ken Watanabe"],
      answer: "Tom Hardy"
    },
    {
      question: "How do they wake up from the dream?",
      options: ["Explosion", "Kick", "Death", "Timer"],
      answer: "Kick"
    },
    {
      question: "What genre is Inception?",
      options: ["Sci-fi", "Horror", "Fantasy", "Documentary"],
      answer: "Sci-fi"
    },
    {
      question: "What does the last scene suggest?",
      options: ["He’s still dreaming", "He’s awake", "He dies", "Open ending"],
      answer: "Open ending"
    }
  ],
  joker: [
    ...
    },
    {
      ...
      options: ["Smile", "Everything is a joke", "Don’t forget to laugh", "Help me"],
      answer: "Everything is a joke"
    },
    {
      question: "What is the theme of Joker?",
      options: ["Heroism", "Comedy", "Mental illness", "Family"],
      answer: "Mental illness"
    },
    {
      question: "How does the movie end?",
      options: ["Joker escapes", "Joker is killed", "Open ending", "Joker arrested"],
      answer: "Open ending"
    },
    {
      question: "What’s Arthur’s dream?",
      options: ["To be loved", "To be famous", "To be a hero", "To host a show"],
      answer: "To be loved"
    },
    {
      question: "What’s the iconic line?",
      options: ["Why so serious?", "You wouldn’t get it", "Let’s put a smile", "I'm Batman"],
  ...
  Avatar: [
    ...
    },
    {
      ...
      options: ["Soldier", "Avatar Trainer", "Scientist", "Spy"],
      answer: "Scientist"
    },
    {
      question: "What is the planet's moon name?",
      options: ["Pandora", "Alpha", "Zion", "Xandar"],
      answer: "Pandora"
    },
    {
      question: "Which studio made Avatar?",
      options: ["Warner Bros", "20th Century Fox", "Marvel", "Universal"],
      answer: "20th Century Fox"
    },
    {
      question: "What happens to Jake at the end?",
      options: ["Dies", "Returns to Earth", "Stays Na'vi", "Becomes RDA Leader"],
      answer: "Stays Na'vi"
    },
    {
      question: "How do Na'vi connect to nature?",
      options: ["Their eyes", "Their tails", "Their hair", "Chants"],
      answer: "Their hair"
    }
  ],
  Venom: [
    ...
    },
    {
      ...
      options: ["Fire", "Ice", "Bullets", "Radiation"],
      answer: "Fire"
    },
    {
      question: "How does Eddie communicate with Venom?",
      options: ["Via phone", "Telepathy", "In his head", "Through dreams"],
      answer: "In his head"
    },
    {
      question: "Who plays the villain Riot’s host?",
      options: ["Riz Ahmed", "Tom Holland", "Woody Harrelson", "Jake Gyllenhaal"],
      answer: "Riz Ahmed"
    },
    {
      question: "What happens to Riot?",
      options: ["Escapes", "Killed", "Returns home", "Becomes friend"],
      answer: "Killed"
    },
    {
      question: "What does Venom call Eddie?",
      options: ["Host", "Partner", "Buddy", "Loser"],
      answer: "Loser"
    }
  ],
  Interstellar: [
    ...
    },
    {
      ...
      options: ["Cube", "Sphere", "4D Space", "Triangle"],
      answer: "4D Space"
    },
    {
      question: "What is Plan B?",
      options: ["Destroy Earth", "Repopulate new planet", "Time travel", "Clone humans"],
      answer: "Repopulate new planet"
    },
    {
      question: "What powers the Endurance spaceship?",
      options: ["Fuel", "Solar", "Fusion", "Gravity"],
      answer: "Gravity"
    },
    {
      question: "Who finds the quantum data?",
      options: ["TARS", "CASE", "Murph", "Cooper"],
      answer: "TARS"
    },
    {
      question: "How does Cooper communicate with Murph in the past?",
      options: ["Phone", "Tesseract", "Dreams", "Video"],
      answer: "Tesseract"
    }
  ],
  Beast: [
  ...
  BlackWidow: [
    ...
    },
    {
      ...
      options: ["Bracelet", "Gas antidote", "Her vest", "USB drive"],
      answer: "Her vest"
    },
    {
    ...
    },
    {
      ...
      options: ["Russia", "Underground", "In the sky", "Siberia"],
      answer: "In the sky"
    },
    {
      question: "What event connects the movie to Avengers: Endgame?",
      options: ["Time travel", "Soul Stone", "Natasha’s sacrifice", "Snapping"],
      answer: "Natasha’s sacrifice"
    },
    {
      question: "What is the main theme of Black Widow?",
      options: ["Revenge", "Family and freedom", "Romance", "Power"],
...
export default function QuestionsPage() {
  ...
  if (!movieQuestions.length) {
    return <div className="questions-container"><h2>No questions found for this movie.</h2></div>;
  }

  return (
    <div className="questions-container">
      <h2 className="progress">Question {currentQuestionIndex + 1} of {numQuestions}</h2>
